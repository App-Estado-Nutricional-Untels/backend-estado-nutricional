...
public class RegistroController {
    ...
    private List<com.untels.estadonutricional.dto.response.Error> getErrores(RegistroBody registroBody) {
        List<com.untels.estadonutricional.dto.response.Error> errores = new ArrayList<>();

        if (usuarioService.existePorCorreoElectronico(
                registroBody.getCorreoElectronico()
        )) {
            errores.add(new com.untels.estadonutricional.dto.response.Error(
                    "correoElectronico",
